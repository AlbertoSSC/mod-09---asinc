...
const showCharacter = (character) => {
    console.log("character:", character.name, character);
...
const showLocations = (location, id) => {
    const element = document.createElement("span");
    element.innerText = id + " : " + location.name + "____ Tipo: "+ location.type + "\n";
    return element;
};

export { createCharacterRow, showCharacter, showLocations };